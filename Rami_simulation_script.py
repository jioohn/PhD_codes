# -*- coding: utf-8 -*-
"""
Created on Tue Dec  1 19:30:32 2020
...
axg2 = plt.axes([0.25, 0.17, 0.65, 0.03])
...
axT = plt.axes([0.25, 0.22, 0.65, 0.03])
...
axTm = plt.axes([0.25, 0.32, 0.65, 0.03])
sTm = Slider(axTm, '$t_m$ ($\mu eV$)', 0, 100, valinit=tm*1e6, valfmt='%1.f',valstep=1)
